...
import { ProfileOptions, SenAddFriendPagram } from '~/routers/main/mainPagramTypes';
...
const ProfilePersonalScreen = () => {
  ...
  const handleSensReq=()=>{
    mainNav.navigate(StackNames.SenAddFriendScreen, {baseProfile: profileData})
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Image source={Assets.images.demo} style={{ width: '100%', height: 300, position: 'absolute' }} />

        <View style={styles.profileDetails}>
          <View style={{flex: 1, backgroundColor: colors.gray_light}}>
            <View style={styles.profileContainer}>
              <Image  source={Assets.images.demo} style={imagesStyle.avatar_big}/>
              <Text style={styles.username}>Nhân</Text>
            </View>

            <View style={{width: '100%', height: 200, marginTop: 100,paddingHorizontal: 25,alignItems: 'center', justifyContent:'center'}}>
              <Text style={textStyle.body_md}>Bạn chưa thể xem nhật kí của Nhân khi chưa là bạn bè</Text>
              <View style={[viewStyle.container_row_between, {paddingHorizontal: 35, gap: 10}]}>
                <AppButton style={{backgroundColor: colors.secondary_light, borderRadius: 20}} leftIcon={Assets.icons.search_white} title='Nhắn tin' onPress={()=>console.log('a')}/>
                <AppButton style={{width: 60, borderRadius: 20, backgroundColor: colors.secondary}} centerIcon={Assets.icons.add_white} onPress={handleSensReq}/>
              </View>
            </View>
          </View>
        </View>
